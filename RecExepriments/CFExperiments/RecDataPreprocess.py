...
from utils import wilson_lower_bound,DLPreprocess
...
"""
from helper import filterModelDt
minUserThreshold = 50
minMlogThreshold = 50
...
"""
The label encode of the categorical features
"""
impressions['newMlogId'] = impressions['mlogId']
numeric_feature_list = ['userClickCount','userZanCount']
cat_feature_list = ['userId','mlogId','songId','artistId','creatorId']
impressions, label_enc_list = DLPreprocess(impressions,cat_feature_list)
...
with open('basicPreprocess.pkl', 'wb') as f:
    pickle.dump([impressions,label_enc_list ,newItems] , f, -1)
