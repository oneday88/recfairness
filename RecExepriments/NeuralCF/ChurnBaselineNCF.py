...
logging.basicConfig(level=logging.DEBUG, filename="ChurnBaselineNCF.log", filemode="w",format="%(asctime)-15s %(levelname)-8s %(message)s")
...
training_log = cf.fit(trainX, trainY, trainer_params_list, subTestDt,recommendDt)
